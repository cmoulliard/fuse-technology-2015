...
* More integrated with Openshift v3, Kubernetes & Docker
...
[#block,width="200px",left="0px",top="200px"]
**DEMO**

[#block,width="200px",left="0px",top="400px"]
REST Camel service, Deploy on Karaf, Expose REST Service using Fabric
Secure endpoint using ApiMan & Keycloak
